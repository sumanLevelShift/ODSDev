...
import createPointsWorkOrderLineItems from '@salesforce/apex/BC_WorkOrderLineItemLWCController.createPointsWorkOrderLineItems';
...
export default class PointsAddSKULWC extends NavigationMixin(LightningElement) {
    @api workOrderId = '';
    @track unitOfMeasure = '';
    @api skuResult = false;
    ...
    handleSave() {
        ...
        createPointsWorkOrderLineItems({
            lineItems: lineItems,
