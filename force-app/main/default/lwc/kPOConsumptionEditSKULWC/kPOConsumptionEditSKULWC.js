...
const FIELDS = [
    ...
    'WorkOrder_Line_Item__c.Description_2__c',
    'WorkOrder_Line_Item__c.Unit_of_Measure__c',
];

export default class KPOConsumptionEditSKULWC extends NavigationMixin(LightningElement) {
    ...
    wiredLineItem({ error, data }) {
        ...
        if (data) {
            ...
            this.lineItemData = {
                ...
                description2: data.fields.Description_2__c.value,
                kpoUOM: data.fields.Unit_of_Measure__c.value,
            };
    ...
    handleDescription2Change(event) {
        this.lineItemData.description2 = event.target.value;
    }
    handleUOMChange(event) {
        const kpoUOMValue = event.detail.value;
        this.lineItemData.kpoUOM = kpoUOMValue;
    }
    // Handle save
    handleSave() {
        ...
        if (this.lineItemData.description2 && this.lineItemData.description2 > 50) {
            this.showToast('Error', 'Description 2 cannot exceed 50 characters', 'error');
            return;
        }
        ...
        const fields = {
            ...
            Description_2__c: this.lineItemData.description2
        };
